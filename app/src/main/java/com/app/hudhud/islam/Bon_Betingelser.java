...
public class Bon_Betingelser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new SampleFragmentPagerAdapter_Bon_Betingelser(getSupportFragmentManager()));
        ...
        toolbar.setTitle("Bønnens betingelser");

//        getSupportActionBar().setTitle("Bønnens betingelser");
